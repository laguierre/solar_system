...
List<PlanetInfo> planets = [
  PlanetInfo(1,
      name: 'Mercury',
      iconImage: 'lib/assets/images/mercury.png',
      description:
  ...
  PlanetInfo(2,
      name: 'Venus',
      iconImage: 'lib/assets/images/venus.png',
      description:
  ...
  PlanetInfo(3,
      name: 'Earth',
      iconImage: 'lib/assets/images/earth.png',
      description:
  ...
  PlanetInfo(4,
      name: 'Mars',
      iconImage: 'lib/assets/images/mars.png',
      description:
  ...
  PlanetInfo(5,
      name: 'Jupiter',
      iconImage: 'lib/assets/images/jupiter.png',
      description:
  ...
  PlanetInfo(6,
      name: 'Saturn',
      iconImage: 'lib/assets/images/saturn.png',
      description:
  ...
  PlanetInfo(7,
      name: 'Uranus',
      iconImage: 'lib/assets/images/uranus.png',
      description:
  ...
  PlanetInfo(8,
      name: 'Neptune',
      iconImage: 'lib/assets/images/neptune.png',
      description:
